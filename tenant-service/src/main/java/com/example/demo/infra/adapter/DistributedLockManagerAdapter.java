...
import com.example.demo.infra.distlock.repository.DistributedLockRepository;
...
class DistributedLockManagerAdapter implements DistributedLockManagerPort {
	...
	public boolean acquireLock(String lockKey, Duration duration) {
		...
		repository.ensureLockExists(lockKey);
		...
		int updatedRows = repository.tryAcquireLock(lockKey, workerId, now, expiresAt);
	...
	public void releaseLock(String lockKey) {
		...
		repository.releaseLock(lockKey, workerId);
	}
}